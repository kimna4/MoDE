...
from agents.representation.modules.ACTION_MINE.representation_action_posi50_gating import ImitationLearning
...
if __name__ == '__main__':
    ...
    argparser.add_argument(
        '-n', '--log_name',
        metavar='T',
        default='represention_action_mine_posi50_v2_gating_T1',
    ...
    argparser.add_argument(
        '--model-path',
        metavar='P',
        default = '7_training_wo_weatmask_posi50_v2_gating.pth',
        type=str,
